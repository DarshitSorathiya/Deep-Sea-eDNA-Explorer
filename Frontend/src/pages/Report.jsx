        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              <span className="text-gradient-sea">Biodiversity</span> Analysis
              Report
            </h1>
            <p className="text-muted-foreground">
              Complete eDNA analysis results for your environmental sample
              dataset
            </p>
          </div>
          ...
          {overviewStats.map((stat, index) => (
            <Card key={index} className="glass-card p-6 hover-glow">
              <div className="flex items-center justify-between">
                ...
                <div className="p-3 rounded-full bg-gradient-sea">
          ...
          <Tabs defaultValue="composition" className="w-full">
            ...
            <TabsContent value="diversity" className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-gradient-sea-subtle rounded-lg">
                      <p className="text-sm text-muted-foreground">
                        Shannon Diversity
                      </p>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {speciesData.slice(0, 4).map((species, index) => (
                      <div
                        key={index}
                        className="flex justify-between items-center p-3 bg-muted/10 rounded-lg"
                      >
            ...
            <TabsContent value="heatmap" className="space-y-4">
              <div className="text-center py-12">
                ...
                <p className="text-sm text-muted-foreground">
                  Interactive heatmap showing species distribution patterns
            ...
            <TabsContent value="map" className="space-y-4">
              <div className="text-center py-12">
                ...
                <p className="text-sm text-muted-foreground">
                  Interactive map showing biodiversity hotspots and sampling
                  locations
                </p>
                <div className="mt-6 p-8 bg-muted/10 rounded-lg">
                  <div className="text-xs text-muted-foreground">
                    Geographic map would be rendered here
                  </div>
                </div>
              </div>
            </TabsContent>
  ...
  {speciesData.map((species, index) => (
    ...
    >
      ...
      <td className="py-3 px-2">
        <Badge
          className={`text-xs ${
            species.confidence > 95 ? "badge-secondary" : "badge-default"
          }`}
        >
          {species.confidence}%
        </Badge>
      ...
      <td className="py-3 px-2 text-sm text-muted-foreground">
        {species.rank}
          ...
          <div className="mt-6 flex justify-center">
            <Button variant="transparent">Load More Results</Button>
          </div>
        </Card>
        ...
        <Card className="glass-card p-6 mt-8">
          <div className="flex items-center space-x-3 text-center justify-center">
            ...
            <p className="text-sm text-muted-foreground">
              Your uploaded data is not stored on our servers. This report was
              generated from temporary analysis and all source data has been
              securely deleted.
            </p>
          </div>
        </Card>
