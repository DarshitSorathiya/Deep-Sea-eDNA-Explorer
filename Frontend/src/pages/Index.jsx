  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Secondary decorative background */}
        {/* <div 
          className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-15"
          style={{ backgroundImage: `url(${dnaBg.src})` }}
        /> */}
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="fade-in">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Mapping{" "}
              <span className="text-gradient-sea handwritten-underline">
                Biodiversity
              </span>{" "}
              from{" "}
              <span className="text-gradient-sea handwritten-underline">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="p-3 rounded-full bg-gradient-sea w-fit mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="text-center">
                <div className="p-4 rounded-full bg-gradient-sea w-fit mx-auto mb-4">
