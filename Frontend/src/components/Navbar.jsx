        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            <div className="p-2 rounded-full bg-gradient-sea">
              <Dna className="h-6 w-6 text-white animate-dna" />
            </div>
            <span className="text-xl font-semibold text-gradient-sea">
              BioDNA
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              ...
              >
                {link.label}
                {pathname === link.href && (
                  <div className="absolute -bottom-1 left-0 right-0 h-0.5 bg-gradient-sea rounded-full" />
                )}
              </Link>
            ))}
          </div>
